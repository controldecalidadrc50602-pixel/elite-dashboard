...
const PortalContent = () => {
  ...
  return (
    <div className="min-h-screen p-8 md:p-12 lg:p-20 max-w-[1600px] mx-auto text-white overflow-x-hidden">
      ...
      {/* Hero Section */}
      <header className="mb-24 flex items-center gap-8">
        {data.logoUrl && (
      ...
      >
        ...
        <div className="md:col-span-2 md:row-span-2 relative overflow-hidden rounded-[40px] bg-white/[0.02] border border-white/5 backdrop-blur-3xl p-12 group hover:border-[var(--brand-primary)]/40 transition-colors duration-700 flex flex-col justify-between">
        ...
        <div className="md:col-span-2 md:row-span-1 relative rounded-[40px] bg-white/[0.02] border border-white/5 backdrop-blur-3xl p-8 group hover:border-[var(--brand-primary)]/40 transition-colors duration-700 flex flex-col justify-between">
        ...
        <div className="md:col-span-1 md:row-span-1 relative overflow-hidden rounded-[40px] bg-white/[0.02] border border-white/5 backdrop-blur-3xl p-10 group hover:border-[var(--brand-primary)]/40 transition-colors duration-700 flex flex-col justify-between">
        ...
        <div className="md:col-span-2 md:row-span-1 relative overflow-hidden rounded-[40px] bg-white/[0.02] border border-white/5 backdrop-blur-3xl p-10 group hover:border-[var(--brand-primary)]/40 transition-colors duration-700 flex flex-col justify-between">
